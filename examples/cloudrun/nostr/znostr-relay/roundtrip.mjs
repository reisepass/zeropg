...
//
// Lives here (not in ../local) so node resolves nostr-tools + ws from this
// package's node_modules (ESM ignores NODE_PATH). Run from this directory:
//   cd examples/cloudrun/nostr/znostr-relay
//   RELAY_URL=wss://nostr-zeropg-4sowr32yyq-ew.a.run.app/ node roundtrip.mjs
// Warm the relay first (curl the URL) so the wss handshake doesn't race a cold boot.
